...
class mNavigationGUI extends mNavigation implements iGUIHTML2 {
	...
	function getCMSHTML($pid = 0, $SeiteID = 0, $DomainID = 0){
		...
		if($pid == 0) {
			...
			$this->setFieldsV3(array("t2.html as activeHTML","t3.html as inactiveHTML","t1.name","t1.DomainID","t1.SeiteID","linkURL","linkType","displaySub","t4.permalink","httpsLink"));
			$this->lCV3();
		}
